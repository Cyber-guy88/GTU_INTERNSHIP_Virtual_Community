...
namespace Data_Access_Layer
{
    public class DALMissionTheme
    {
        ...
        public async Task<MissionTheme> Test(MissionTheme data)
        {
            var extData = await _cIDbContext.MissionTheme.FirstOrDefaultAsync(u => !u.IsDeleted && u.Id == data.Id);
            if (extData != null)
            {
                extData.IsDeleted = true;   
            };
